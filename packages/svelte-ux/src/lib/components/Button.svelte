<script lang="ts">
  ...
  interface Props {
    ...
    loading?: boolean;
    disabled?: boolean;
    rounded?: ButtonRounded; // default in reactive groupContext below
    variant?: ButtonVariant; // default in reactive groupContext below
    size?: ButtonSize; // default in reactive groupContext below
    color?: ButtonColor; // default in reactive groupContext below
