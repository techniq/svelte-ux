import type { Variables } from '$lib/config/variables';
import {
  startOfMonth,
  endOfMonth,
  subMonths,
...
export const fiscalYearPresets = getDateRangePresets(
    ...
    case 'productivity':
      return [
        ...
        },
        {
          ...
          value: biWeekSun1Presets.find((x) => x.label === 'Last 6 Bi-Weeks')!
            .value,
        },
        {
          label: 'Last 6 Pay Periods (SMMC)',
          value: biWeekMon1Presets.find((x) => x.label === 'Last 6 Bi-Weeks')!
            .value,
        },
        {
          label: 'Current Month',
        ...
        },
        {
          ...
          value: quarterPresets.find((x) => x.label === 'Last 4 Quarters')!
            .value,
        },
        {
    ...
    case 'financial':
      return [
        ...
        },
        {
          ...
          value: fiscalYearPresets.find((x) => x.label === 'Last Fiscal Year')!
            .value,
        },
        {
          label: 'Last 3 Fiscal Years',
          value: fiscalYearPresets.find((x) => x.label === 'Last 3 Years')!
            .value,
        },
      ];
  }
